 ...
 * http://www.i286.org/highcharts/adapter/adapter-extjs.js
 * @version 0.4
...
HighchartsAdapter = {
  ...
  merge: function() {
    ...
    var jqextend = function() {
      ...
      if (typeof target !== "object" && !Ext.isFunction(target)) target = {};
      ...
      for (var name in options) {
        ...
        if (deep && copy && typeof copy === "object" && !copy.nodeType) target[name] = jqextend(deep,
